...
class ProfileView(APIView):
	...
	def get(self, *args, **kwargs):
		...
		new_friend_list=[{"image":(get_object_or_404(Profile, id=x)).image.name,"username":(get_object_or_404(Profile, id=x)).user.username} for x in serializer.data["friends"]]
